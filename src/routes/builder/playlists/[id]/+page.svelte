...
<!-- 
	public/private? {playlist.public}
{playlist.name}
description {playlist.description}
{playlist.owner.display_name}, {playlist.followers.total} likes, playlist.tracks.items.length, total time
open in spotify
 -->
<Container>
	<div class="flex flex-wrap gap-4 mb-2">
		...
		<div class="basis-3/5 flex-grow">
			...
			<a href="spotify:playlist:{playlist.id}" class="text-gray-800 hover:text-gray-600 text-sm mb-2 mt-3 flex items-center"
